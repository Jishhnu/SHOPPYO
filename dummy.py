...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'Page.settings')  # ✅ FIXED
...
from customer.models import OrderItem, Cart, CartItem, Wishlist, WishlistItem, Review, Order
...
from seller.models import (
    Attribute, AttributeOption, ProductImage, 
